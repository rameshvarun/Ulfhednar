function collideRect(ax1, ay1, ax2, ay2, bx1, by1, bx2, by2)
...
Taken from https://love2d.org/wiki/DistanceBasedCollision ]]--
...
--Functions below this are taken from https://love2d.org/wiki/PointWithinShape
